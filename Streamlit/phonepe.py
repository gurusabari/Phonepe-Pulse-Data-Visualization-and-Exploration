...
df1 = pd.read_csv('D:/Program Files/Visual Studio/New folder/data/india_map.csv')

# Read the "Bar_chart" CSV file into a DataFrame
df2 = pd.read_csv('D:/Program Files/Visual Studio/New folder/data/bar_chart.csv')

# Read the "Histogram_district" CSV file into a DataFrame :
df3 = pd.read_csv('D:/Program Files/Visual Studio/New folder/data/histogram_district.csv')

# Read the "Histogram_state" CSV file into a DataFrame :
df4 = pd.read_csv('D:/Program Files/Visual Studio/New folder/data/line_plot.csv')
...
def main():
    ...
    option = st.sidebar.radio('Select Visualization of transactions', ('Choropleth Map', 'Brand Wise', 'District Wise', 'Top Ten States By Count' ,'Top Ten Sates By Transaction Amount'))
    ...
    if option == 'Choropleth Map':
         ...
         main_district_wise()
    elif option =='Top Ten States By Count':
         main_top_10_states()
    elif option =='Top Ten Sates By Transaction Amount':
         main_top_10_states_trans_amount()
        
    # Create sidebar with select options
    option = st.sidebar.radio('Select Visualization of Users Analysis', ('Users Analysis', 'Top User By Type'))

    if option == 'Users Analysis':  
        main_line_plot()
    elif option == 'Top User By Type':
        main_histo_plot()
...
def main_district_wise():
    ...
    plt.xlabel('Count (Billions)')  # Updated x-axis label
    plt.ylabel('District')
    ...
    plt.xlabel('Amount (Billions)')  # Updated x-axis label
    plt.ylabel('District')
